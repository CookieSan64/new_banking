...
local bankMenu	= true
local banks = {
	{name="Banque", id=108, x=150.1958, y=-1040.837, z=29.37121},
	...
	{name="Banque", id=108, x=-561.1495, y=-585.1448, z=41.77667},
}	
...
local atms = {
	...
	{name="ATM", id=277, x=-569.8461, y=-592.2825, z=41.43023},
	{name="ATM", id=277, x=-569.8373, y=-585.9638, z=41.43024},
	{name="ATM", id=277, x=-32.20399, y=-1104.347, z=27.27436},
	{name="ATM", id=277, x=357.0015, y=173.483, z=103.0667},
	{name="ATM", id=277, x=-589.2946, y=30.31996, z=31.79789},
	{name="ATM", id=277, x=127.3843, y=-1296.195, z=29.26933},

	{name="ATM", id=277, x=2747.863, y=3478.259, z=55.6954},
}
--================================================================================================
...
if bankMenu then
	...
	if nearBank() or nearATM() then
			DisplayHelpText("Appuiez sur ~INPUT_PICKUP~ pour accèder à tes comptes ~b~")
